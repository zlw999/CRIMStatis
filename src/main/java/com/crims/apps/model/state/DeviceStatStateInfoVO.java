...
public class DeviceStatStateInfoVO {
    private String lineId		= "";		// 线路编号   8101
    private String lineName	= "";		// 线路名称       呼和浩特01
    private String stationId	= "";		// 车站编号      810101
    private String stationName	= "";		// 车站名称      呼和I

    private int devCount		= 0;		// 设备数量      5
    private int offlineCount	= 0;		// 离线的设备数量

    private int faultCount		= 0;		// 存在故障的设备数量   2


    private String onlineRatio	= "";		// 设备在线率(保留1位小数，单位%)
    private String faultRatio	= "";		// 设备故障率(保留1位小数，单位%) 百分之40
